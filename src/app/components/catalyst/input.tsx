    ...
    >
      <Headless.Input
        ...
        className={clsx([
          ...
          // Basic layout
          'relative block w-full appearance-none rounded-lg px-[calc(calc(var(--spacing)*3.5)-1px)] py-[calc(calc(var(--spacing)*2.5)-1px)] sm:px-[calc(calc(var(--spacing)*3)-1px)] sm:py-[calc(calc(var(--spacing)*1.5)-1px)]',
          // Typography
