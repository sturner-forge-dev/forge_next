...
const styles = {
  base: [
    ...
    // Focus
    'focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-blue-500 cursor-pointer disabled:cursor-not-allowed',
    // Disabled
